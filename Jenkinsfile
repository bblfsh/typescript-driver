pipeline {
  agent {
    kubernetes {
      label 'typescript-driver-bblfsh-performance'
      defaultContainer 'typescript-driver-bblfsh-performance'
      yaml """
spec:
  nodeSelector:
  ...
  containers:
  - name: typescript-driver-bblfsh-performance
...
"""
  ...
  environment {
    DRIVER_LANGUAGE = "typescript"
    DRIVER_REPO = "https://github.com/bblfsh/typescript-driver.git"
